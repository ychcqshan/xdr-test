...
public class AlertService {
    ...
    public PageResponse<Alert> listAlerts(int page, int size, String level,
            String status, String agentId, String threatType, String unitLevel1, String unitLevel2, 
            String unitLevel3, String unitLevel4, String responsiblePerson) {
        ...
        if (StringUtils.hasText(unitLevel3))
            query.eq("unit_level3", unitLevel3);
        if (StringUtils.hasText(unitLevel4))
            query.eq("unit_level4", unitLevel4);
